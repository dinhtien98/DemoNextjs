...
export default function SideBar() {
  ...
  return (
    <>
      <div
        className={`p-4 bg-white shadow-lg rounded-lg fixed top-0 left-0 z-10 transition-transform transform ${
